...
class BowAndArrowGameRL:
    ...
    def __init__(self, w=600, h=400):
        ...
        # Load images
        self.character_img = pygame.image.load("../images/character_small.png")
        self.red_balloon_img = pygame.image.load("../images/balloon_small.png")
        self.arrow_img = pygame.image.load("../images/arrow_small.png")
        self.red_balloon_falling_img = pygame.image.load("../images/red_balloon_falling_small.png")
        self.grid = []
